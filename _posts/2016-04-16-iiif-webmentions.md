...
![commandline-webmention.png]({{ site.assets_url }}commandline-webmention.png)
...
![Webmentions-ecod-1-webmentions-notification]({{ site.assets_url }}Webmentions-ecod-1-webmentions-notification.png)
...
![Webmentions-ecod-2-webmentions-queue]({{ site.assets_url }}Webmentions-ecod-2-webmentions-queue.png)
...
![Webmentions-ecod-3a-webmention-preview.searchWithin]({{ site.assets_url }}Webmentions-ecod-3a-webmention-preview.searchWithin.png)

Here is a SCTA range list or table of contents that e-codices learned about via a IIIF webmention:

![Webmentions-ecod-3b-webmention-preview-rangelist]({{ site.assets_url }}Webmentions-ecod-3b-webmention-preview-rangelist.png)
...
![Webmentions-ecod-4-iiif-supplements]({{ site.assets_url }}Webmentions-ecod-4-iiif-supplements.png)
...
![Webmentions-ecod-5-searchWithin-manifest]({{ site.assets_url }}Webmentions-ecod-5-searchWithin-manifest.png)

And it will include a set of ranges provided by the *Scholastic Commentaries and Texts Archive*.:

![Webmentions-ecod-6-rangelist-manifest]({{ site.assets_url }}Webmentions-ecod-6-rangelist-manifest.png)
...
![miradorview-before]({{ site.assets_url }}miradorview-before.png)

After the webmentions have been processed, the user can now experience e-codices' own collection in a richer way.

With a table of contents:

![mirador-view-after-toc]({{ site.assets_url }}mirador-view-after-toc.png)

With a transcription search service:

![mirador-view-after-search]({{ site.assets_url }}mirador-view-after-search.png)

With transcription annotations:

![mirador-view-after-annotations]({{ site.assets_url }}mirador-view-after-annotations.png)

With the possibility of adding multiple layers of annotations, including translations and comments:

![mirador-annotations]({{ site.assets_url }}mirador_annotations.png)
...
![map-slide]({{ site.assets_url }}map-slide-image.png)
